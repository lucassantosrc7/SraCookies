...
public class MarcarVida : MonoBehaviour {
	...
	void Update () {
		if (GetComponent<SrCookiesBoss> ().vida == 1) {
			i1.gameObject.SetActive (true);
			i2.gameObject.SetActive (false);
			i3.gameObject.SetActive (false);
			i4.gameObject.SetActive (false);
			i5.gameObject.SetActive (false);
		} else if (GetComponent<SrCookiesBoss> ().vida == 2) {
			i1.gameObject.SetActive (true);
			i2.gameObject.SetActive (true);
			i3.gameObject.SetActive (false);
			i4.gameObject.SetActive (false);
			i5.gameObject.SetActive (false);
		} else if (GetComponent<SrCookiesBoss> ().vida == 3) {
			i1.gameObject.SetActive (true);
			i2.gameObject.SetActive (true);
			i3.gameObject.SetActive (true);
			i4.gameObject.SetActive (false);
			i5.gameObject.SetActive (false);
		} else if (GetComponent<SrCookiesBoss> ().vida == 4) {
			i1.gameObject.SetActive (true);
			i2.gameObject.SetActive (true);
			i3.gameObject.SetActive (true);
			i4.gameObject.SetActive (true);
			i5.gameObject.SetActive (false);
		} else if (GetComponent<SrCookiesBoss> ().vida >= 5) {
			i1.gameObject.SetActive (true);
			i2.gameObject.SetActive (true);
			i3.gameObject.SetActive (true);
			i4.gameObject.SetActive (true);
